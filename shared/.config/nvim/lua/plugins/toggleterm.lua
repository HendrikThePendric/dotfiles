return {
    ...
    opts = {
        ...
        float_opts = {
            ...
            border = {{"╭", "ToggleTermFloatBorder"}, {"─", "ToggleTermFloatBorder"},
                      {"╮", "ToggleTermFloatBorder"}, {"│", "ToggleTermFloatBorder"},
                      {"╯", "ToggleTermFloatBorder"}, {"─", "ToggleTermFloatBorder"},
                      {"╰", "ToggleTermFloatBorder"}, {"│", "ToggleTermFloatBorder"}}
        }
    },
    config = function(_, opts)
        ...
        map("<leader>zdd", function()
            ...
            for _, direction in ipairs({"float", "horizontal", "vertical"}) do
                local terms = get_terminals_by_direction(direction)
                print(string.format("%s: %d terminals, visible: %s", direction, #terms,
                    tostring(is_direction_visible(direction))))
                for _, term in ipairs(terms) do
